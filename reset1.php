...
<table border=0 cellspacing=3 cellpadding=10 id=content bgcolor=336699>
	<tr>
		<td align=left bgcolor=FFFFFF>
			<form method=post action=reset1.php name=myform>
<?php
if($usergood == 1){
    ...
    echo "Please enter your email address:<br><font color=red>Email address not found</font><br>Email Address:<br><input type=text name=email size=50 autocomplete=off><br>\n";
} else {
